          ...
          <div className="flex items-center space-x-4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  className="relative h-8 w-8 rounded-full bg-slate-100 text-slate-700 hover:bg-slate-200"
                >
              ...
              <DropdownMenuContent
                className="w-56 bg-white/95 backdrop-blur-sm border border-slate-200 shadow-lg"
                align="end"
                forceMount
              >
